...
#include "../../simulator_drivers/simulator_drivers.h"
...
static void action_window(lv_group_t *_group)
{
	...
	lv_group_add_obj(_group,close_btn);
	...
	lv_group_add_obj(_group,checkbox);
	...
	lv_group_set_focus_cb(_group,focus_cb);
}


static void focus_cb(lv_group_t * _group)
{
	lv_obj_t* obj = lv_group_get_focused(_group);
